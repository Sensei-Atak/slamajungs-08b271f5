...
import { ImageIcon, Crop, Check } from "lucide-react";
...
const ASPECT = 9 / 16; // Portrait aspect ratio
        ...
        <form onSubmit={handlePost} className="space-y-3">
          ...
          {!rawImage && (
            <label className="flex flex-col items-center gap-2 cursor-pointer border-2 border-dashed border-border rounded-lg p-6 justify-center hover:border-primary/50 transition-colors">
              ...
              <span className="text-xs text-muted-foreground/60">Wird automatisch auf Hochformat zugeschnitten</span>
